"""
Django settings for spacare project.
...
SECRET_KEY = "django-insecure-qi#pw7py)mey5ay@)^1jl-n@v5-38*+2y_way*mj#)q!9h@#7n"
...
WSGI_APPLICATION = "spacare.wsgi.application"
